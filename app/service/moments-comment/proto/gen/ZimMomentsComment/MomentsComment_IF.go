// Package ZimMomentsComment comment
// This file was generated by tars2go 1.1
// Generated from moments_comment.tars
package ZimMomentsComment
...
// MomentsComment struct
type MomentsComment struct {
	s m.Servant
}

// Add is the proxy function for the method defined in the tars file, with the context
func (_obj *MomentsComment) Add(Lh int32, Rh int32, Res *int32, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *MomentsComment) AddWithContext(ctx context.Context, Lh int32, Rh int32, Res *int32, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *MomentsComment) Sub(Lh int32, Rh int32, Res *int32, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *MomentsComment) SubWithContext(ctx context.Context, Lh int32, Rh int32, Res *int32, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *MomentsComment) SetServant(s m.Servant) {
	_obj.s = s
}

// TarsSetTimeout sets the timeout for the servant which is in ms.
func (_obj *MomentsComment) TarsSetTimeout(t int) {
	_obj.s.TarsSetTimeout(t)
}

// TarsSetHashCode sets the hash code for client calling the server , which is for Message hash code.
func (_obj *MomentsComment) TarsSetHashCode(code int64) {
...
func (_obj *MomentsComment) AddServant(imp _impMomentsComment, obj string) {
	tars.AddServant(_obj, imp, obj)
}

// AddServant adds servant  for the service with context.
func (_obj *MomentsComment) AddServantWithContext(imp _impMomentsCommentWithContext, obj string) {
	tars.AddServantWithContext(_obj, imp, obj)
}

type _impMomentsComment interface {
	Add(Lh int32, Rh int32, Res *int32) (ret int32, err error)
	Sub(Lh int32, Rh int32, Res *int32) (ret int32, err error)
}
type _impMomentsCommentWithContext interface {
...
func Add(ctx context.Context, _val any, _os *codec.Buffer, _is *codec.Reader, withContext bool) (err error) {
	...
	if withContext == false {
		...
		_imp := _val.(_impMomentsCommentWithContext)
...
func (_obj *MomentsComment) Dispatch(ctx context.Context, _val any, req *requestf.RequestPacket, resp *requestf.ResponsePacket, withContext bool) (err error) {
