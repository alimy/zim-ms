...
func (s authSrv) Add(c context.Context, lh int32, rh int32, res *int32) (int32, error) {
...
func (s authSrv) Sub(c context.Context, lh int32, rh int32, res *int32) (int32, error) {
	//todo: something in your function
	*res = lh - rh
	return 0, nil
}
