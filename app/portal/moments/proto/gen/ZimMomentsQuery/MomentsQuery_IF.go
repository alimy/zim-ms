// Package ZimMomentsQuery comment
// This file was generated by tars2go 1.1
// Generated from moments_query.tars
package ZimMomentsQuery
...
func (_obj *MomentsQuery) Add(Lh int32, Rh int32, Res *int32, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *MomentsQuery) AddWithContext(ctx context.Context, Lh int32, Rh int32, Res *int32, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *MomentsQuery) Sub(Lh int32, Rh int32, Res *int32, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *MomentsQuery) SubWithContext(ctx context.Context, Lh int32, Rh int32, Res *int32, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *MomentsQuery) SetServant(s m.Servant) {
	_obj.s = s
}

// TarsSetTimeout sets the timeout for the servant which is in ms.
func (_obj *MomentsQuery) TarsSetTimeout(t int) {
	_obj.s.TarsSetTimeout(t)
}

// TarsSetHashCode sets the hash code for client calling the server , which is for Message hash code.
func (_obj *MomentsQuery) TarsSetHashCode(code int64) {
	s := _obj.s.(*tars.ServantProxy)
	s.TarsSetHashCode(code)
}
func (_obj *MomentsQuery) setMap(l int, res *requestf.ResponsePacket, ctx map[string]string, sts map[string]string) {
	if l == 1 {
		for k, _ := range ctx {
			delete(ctx, k)
		}
...
func (_obj *MomentsQuery) AddServant(imp _impMomentsQuery, obj string) {
	tars.AddServant(_obj, imp, obj)
}

// AddServant adds servant  for the service with context.
func (_obj *MomentsQuery) AddServantWithContext(imp _impMomentsQueryWithContext, obj string) {
	tars.AddServantWithContext(_obj, imp, obj)
}

type _impMomentsQuery interface {
	Add(Lh int32, Rh int32, Res *int32) (ret int32, err error)
	Sub(Lh int32, Rh int32, Res *int32) (ret int32, err error)
}
type _impMomentsQueryWithContext interface {
...
func Add(ctx context.Context, _val any, _os *codec.Buffer, _is *codec.Reader, withContext bool) (err error) {
	...
	if withContext == false {
		...
		_imp := _val.(_impMomentsQueryWithContext)
...
func (_obj *MomentsQuery) Dispatch(ctx context.Context, _val any, req *requestf.RequestPacket, resp *requestf.ResponsePacket, withContext bool) (err error) {
