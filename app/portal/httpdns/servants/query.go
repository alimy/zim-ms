...
import (
	...
	"gitbus.com/exlab/zim-ms/app/portal/httpdns/proto/gen/ZimDnsQuery"
)

type querySrv struct {
	dr.BaseServant
	query *ZimDnsQuery.DnsQuery
}
...
// NewDnsQuery return a DnsQuery implement object
func NewDnsQuery() query.DnsQuery {
	return &querySrv{
		BaseServant: dr.NewSimpleServant(),
		query:       newDnsQueryApp(),
	}
}
