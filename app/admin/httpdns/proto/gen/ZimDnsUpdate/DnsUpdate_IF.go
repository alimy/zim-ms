// Package ZimDnsUpdate comment
// This file was generated by tars2go 1.1
// Generated from dns_update.tars
package ZimDnsUpdate
...
func (_obj *DnsUpdate) Add(Lh int32, Rh int32, Res *int32, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *DnsUpdate) AddWithContext(ctx context.Context, Lh int32, Rh int32, Res *int32, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *DnsUpdate) Sub(Lh int32, Rh int32, Res *int32, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *DnsUpdate) SubWithContext(ctx context.Context, Lh int32, Rh int32, Res *int32, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *DnsUpdate) SetServant(s m.Servant) {
	_obj.s = s
}

// TarsSetTimeout sets the timeout for the servant which is in ms.
func (_obj *DnsUpdate) TarsSetTimeout(t int) {
	_obj.s.TarsSetTimeout(t)
}

// TarsSetHashCode sets the hash code for client calling the server , which is for Message hash code.
func (_obj *DnsUpdate) TarsSetHashCode(code int64) {
	s := _obj.s.(*tars.ServantProxy)
	s.TarsSetHashCode(code)
}
func (_obj *DnsUpdate) setMap(l int, res *requestf.ResponsePacket, ctx map[string]string, sts map[string]string) {
	if l == 1 {
		for k, _ := range ctx {
			delete(ctx, k)
		}
...
func (_obj *DnsUpdate) AddServant(imp _impDnsUpdate, obj string) {
	tars.AddServant(_obj, imp, obj)
}

// AddServant adds servant  for the service with context.
func (_obj *DnsUpdate) AddServantWithContext(imp _impDnsUpdateWithContext, obj string) {
	tars.AddServantWithContext(_obj, imp, obj)
}

type _impDnsUpdate interface {
	Add(Lh int32, Rh int32, Res *int32) (ret int32, err error)
	Sub(Lh int32, Rh int32, Res *int32) (ret int32, err error)
}
type _impDnsUpdateWithContext interface {
...
func Add(ctx context.Context, _val any, _os *codec.Buffer, _is *codec.Reader, withContext bool) (err error) {
	...
	if withContext == false {
		...
		_imp := _val.(_impDnsUpdateWithContext)
...
func (_obj *DnsUpdate) Dispatch(ctx context.Context, _val any, req *requestf.RequestPacket, resp *requestf.ResponsePacket, withContext bool) (err error) {
