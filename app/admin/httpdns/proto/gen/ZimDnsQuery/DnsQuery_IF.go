// Package ZimDnsQuery comment
// This file was generated by tars2go 1.1
// Generated from dns_query.tars
package ZimDnsQuery
...
func (_obj *DnsQuery) Add(Lh int32, Rh int32, Res *int32, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *DnsQuery) AddWithContext(ctx context.Context, Lh int32, Rh int32, Res *int32, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *DnsQuery) Sub(Lh int32, Rh int32, Res *int32, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *DnsQuery) SubWithContext(ctx context.Context, Lh int32, Rh int32, Res *int32, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *DnsQuery) SetServant(s m.Servant) {
	_obj.s = s
}

// TarsSetTimeout sets the timeout for the servant which is in ms.
func (_obj *DnsQuery) TarsSetTimeout(t int) {
	_obj.s.TarsSetTimeout(t)
}

// TarsSetHashCode sets the hash code for client calling the server , which is for Message hash code.
func (_obj *DnsQuery) TarsSetHashCode(code int64) {
	s := _obj.s.(*tars.ServantProxy)
	s.TarsSetHashCode(code)
}
func (_obj *DnsQuery) setMap(l int, res *requestf.ResponsePacket, ctx map[string]string, sts map[string]string) {
	if l == 1 {
		for k, _ := range ctx {
			delete(ctx, k)
		}
...
func (_obj *DnsQuery) AddServant(imp _impDnsQuery, obj string) {
	tars.AddServant(_obj, imp, obj)
}

// AddServant adds servant  for the service with context.
func (_obj *DnsQuery) AddServantWithContext(imp _impDnsQueryWithContext, obj string) {
	tars.AddServantWithContext(_obj, imp, obj)
}

type _impDnsQuery interface {
	Add(Lh int32, Rh int32, Res *int32) (ret int32, err error)
	Sub(Lh int32, Rh int32, Res *int32) (ret int32, err error)
}
type _impDnsQueryWithContext interface {
...
func Add(ctx context.Context, _val any, _os *codec.Buffer, _is *codec.Reader, withContext bool) (err error) {
	...
	if withContext == false {
		...
		_imp := _val.(_impDnsQueryWithContext)
...
func (_obj *DnsQuery) Dispatch(ctx context.Context, _val any, req *requestf.RequestPacket, resp *requestf.ResponsePacket, withContext bool) (err error) {
