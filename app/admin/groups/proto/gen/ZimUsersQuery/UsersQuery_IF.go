// Package ZimUsersQuery comment
// This file was generated by tars2go 1.1
// Generated from users_query.tars
package ZimUsersQuery
...
func (_obj *UsersQuery) Add(Lh int32, Rh int32, Res *int32, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *UsersQuery) AddWithContext(ctx context.Context, Lh int32, Rh int32, Res *int32, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *UsersQuery) Sub(Lh int32, Rh int32, Res *int32, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *UsersQuery) SubWithContext(ctx context.Context, Lh int32, Rh int32, Res *int32, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *UsersQuery) SetServant(s m.Servant) {
	_obj.s = s
}

// TarsSetTimeout sets the timeout for the servant which is in ms.
func (_obj *UsersQuery) TarsSetTimeout(t int) {
	_obj.s.TarsSetTimeout(t)
}

// TarsSetHashCode sets the hash code for client calling the server , which is for Message hash code.
func (_obj *UsersQuery) TarsSetHashCode(code int64) {
	s := _obj.s.(*tars.ServantProxy)
	s.TarsSetHashCode(code)
}
func (_obj *UsersQuery) setMap(l int, res *requestf.ResponsePacket, ctx map[string]string, sts map[string]string) {
	if l == 1 {
		for k, _ := range ctx {
			delete(ctx, k)
		}
...
func (_obj *UsersQuery) AddServant(imp _impUsersQuery, obj string) {
	tars.AddServant(_obj, imp, obj)
}

// AddServant adds servant  for the service with context.
func (_obj *UsersQuery) AddServantWithContext(imp _impUsersQueryWithContext, obj string) {
	tars.AddServantWithContext(_obj, imp, obj)
}

type _impUsersQuery interface {
	Add(Lh int32, Rh int32, Res *int32) (ret int32, err error)
	Sub(Lh int32, Rh int32, Res *int32) (ret int32, err error)
}
type _impUsersQueryWithContext interface {
...
func Add(ctx context.Context, _val any, _os *codec.Buffer, _is *codec.Reader, withContext bool) (err error) {
	...
	if withContext == false {
		...
		_imp := _val.(_impUsersQueryWithContext)
...
func (_obj *UsersQuery) Dispatch(ctx context.Context, _val any, req *requestf.RequestPacket, resp *requestf.ResponsePacket, withContext bool) (err error) {
